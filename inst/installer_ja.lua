...
local properties                = {
    ...
    localization      = {
        ...
        title         = "AntwitchOSインストーラー",
        -- Use <currentProgress>, <totalProgress> and <currentFile> text insertions to automatically display their values
        currentFile   = "ファイル: \"<currentFile>\"",
        totalProgress = "進捗状況: <totalProgress>%",
        -- Comment this lines to automatically close installer window
        finished1     = "AntwitchOSは正常にインストールされました。",
	      finished2     = "再起動をしてください。",
	      finished3     = "何らかのキーを押すと終了します..."
    },
